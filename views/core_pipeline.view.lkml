view: core_pipeline {
  sql_table_name: public.core_pipeline ;;
  drill_fields: [id]
  ...
  dimension_group: enter {
    ...
    sql: ${TABLE}.enter_time ;;
  }

  dimension: free_text_requirements {
    type: string
    sql: ${TABLE}.free_text_requirements ;;
  }
  ...
  dimension: sales_assignee {
    type: string
    sql: ${TABLE}.sales_assignee ;;
  }
